            ...
            .then((res) => {
                ...
                if (skills?.chapters) {
                    ...
                    const filtered = skills.chapters.filter(
                        (c) => !["Habits", "Manner", "Manners", "Discipline"].includes(c.name)
                    );
    ...
    return (
        <>
            <div className="skill-banner">
                <img loading="lazy"  src="assets/skill-banner.jpg" alt="Skill-Banner" className="skill-banner-img"/>
            </div>
                        ...
                        <div className="skill-block">
                            ...
                            <div className="skill-card">
                                <div className="skill-image">
                                    <img loading="lazy"  src="assets/habits.jpg" alt="Habits-card" className="skill-img"/>
                                </div>
                            ...
                            <div className="skill-card">
                                <div className="skill-image">
                                    <img loading="lazy"  src="assets/Manners.jpg" alt="Manners-card" className="skill-img"/>
                                </div>
                                <div className="skill-content">
                            ...
                            <div className="skill-card">
                                <div className="skill-image">
                                    <img loading="lazy"  src="assets/Discipline.jpg" alt="Discipline-card" className="skill-img"/>
                                </div>
                                <div className="skill-content">
                            ...
                            {chapters.map((chapter) => (
                                <div className="skill-card" key={chapter._id}>
                                    <div className="skill-image">
                                        <img loading="lazy"  src={chapter.img || "assets/default.jpg"} alt={chapter.name} className="skill-img"/>
                                    </div>
                                    <div className="skill-content">
