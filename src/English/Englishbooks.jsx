      ...
      try {
        ...
        if (english?.chapters) {
          ...
          const filtered = english.chapters.filter(
            (c) => !["Alphabets", "Colors", "Animals", "Alphabet Adventure", "Magic of Colour", "Jungle Friends"].includes(c.name)
          );
  ...
  return (
    <>
      <div className="english-banner-img">
        <img loading="lazy"  src="assets/English-book-banner.jpg" alt="EnglishWorld-Banner" />
      </div>
            ...
            <div className="english-book-block">
              ...
              <div className="english-books">
                <div className="english-book-image">
                  <img loading="lazy"  src="assets/AtoZ.jpg" alt="AToZ-book" />
                </div>
              ...
              <div className="english-books">
                <div className="english-book-image">
                  <img loading="lazy"  src="assets/Colors.jpg" alt="Color-book" />
                </div>
                <div className="english-book-content">
              ...
              <div className="english-books">
                <div className="english-book-image">
                  <img loading="lazy"  src="assets/Animals.jpg" alt="Animal-book" />
                </div>
                <div className="english-book-content">
              ...
              {dynamicChapters.map((chapter) => (
                <div className="english-books" key={chapter._id}>
                  <div className="english-book-image">
                    <img loading="lazy"  src={chapter.img || "assets/default.jpg"} alt={chapter.name} />
                  </div>
                  <div className="english-book-content">
