    ...
    return(
        <>
            ...
            <div className="dashboard-banner">
                <img loading="lazy"  src="assets/dashboard-image-removebg-preview.png" alt="dashboard-banner" className="dashboard-img" />
            </div>
                        ...
                        <div className="dashboard-block">
                            ...
                            <div className="dashboard-card">
                                <div className="dashboard-img">
                                    <img loading="lazy"  src="assets/manage-book.jpg" alt="manage-book-img" className="dashboard-card-img"/>
                                </div>
                            ...
                            <div className="dashboard-card">
                                <div className="dashboard-img">
                                    <img loading="lazy"  src="assets/contact-dashboard.jpg" alt="feedback-img" className="dashboard-card-img"/>
                                </div>
                                <div className="dashboard-text">
                            ...
                            <div className="dashboard-card">
                                <div className="dashboard-img">
                                    <img loading="lazy"  src="assets/user-login.jpg" alt="feedback-img" className="dashboard-card-img"/>
                                </div>
                                <div className="dashboard-text">
