                ...
                <div className="container">
                    <div className="weather-inner">
                        ...
                        <div className="weather-block">
                            ...
                            <div className="weather-card">
                                <div className="weather-img">
                                    <img loading="lazy"  src="\assets\stormy.jpg" alt="stormy" onMouseEnter={() => speakWeather("stormy")}/>
                                </div>
                                <div className="weather-content">
                            ...
                            <div className="weather-card">
                                <div className="weather-img">
                                    <img loading="lazy"  src="\assets\cloudy.jpg" alt="cloudy" onMouseEnter={() => speakWeather("cloudy")}/>
                                </div>
                                <div className="weather-content">
                            ...
                            <div className="weather-card">
                                <div className="weather-img">
                                    <img loading="lazy"  src="\assets\snowy.jpg" alt="snowy" onMouseEnter={() => speakWeather("snowy")}/>
                                </div>
                                <div className="weather-content">
                            ...
                            <div className="weather-cards">
                                <div className="weather-img">
                                    <img loading="lazy"  src="\assets\rainbow.jpg" alt="rainbow" onMouseEnter={() => speakWeather("rainbow")}/>
                                </div>
                                <div className="weather-content">
