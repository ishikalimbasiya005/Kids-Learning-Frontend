    ...
    return (
        <>
            <div className="math-banner">
                <img loading="lazy"  src="assets/Math-banner.jpg" alt="Math-banner" />
            </div>
                        ...
                        <div className="math-block">
                            ...
                            <div className="math-cards">
                                <div className="math-image">
                                    <img loading="lazy"  src="assets/numbers-label.jpg" alt="Numbers-image" />
                                </div>
                            ...
                            <div className="math-cards">
                                <div className="math-image">
                                    <img loading="lazy"  src="assets/sign-card.jpg" alt="Sign-card" />
                                </div>
                                <div className="math-content">
                            ...
                            {dynamicBooks.map((book) => (
                                <div className="math-cards" key={book._id}>
                                    <div className="math-image">
                                        <img loading="lazy"  src={book.img || "assets/default.jpg"} alt={book.name} />
                                    </div>
                                    <div className="math-content">
