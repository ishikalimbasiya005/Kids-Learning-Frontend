...
const Contact = () => {
  ...
  return (
    <div className="contact-banner">
      <img loading="lazy"  src="assets/contact-banner.jpg" alt="contact-banner" className="contact-banner-img" />
      ...
      <div className="contact-outer">
        <div className="container">
          <div className="contact-inner">
            <img loading="lazy"  src="assets/call-removebg-preview.png" alt="contact-call-image" />
            ...
            <img loading="lazy"  src="assets/contact-girl-removebg-preview.png" alt="contact-message" className="contact-msges" />
          </div>
        </div>
      </div>
    </div>
